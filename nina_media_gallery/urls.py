...
urlpatterns = [
    ...
    path('<uuid:id>/delete-flutter/', views.delete_media_flutter, name='delet_media_flutter'),
    path('<uuid:id>/edit-flutter/', views.edit_media_flutter, name='edit_media_flutter'),
]